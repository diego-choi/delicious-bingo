...
export default function HomePage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* 히어로 섹션 */}
      <section className="text-center py-8 sm:py-12 px-4 bg-brand-beige rounded-xl sm:rounded-2xl">
        <h1 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-4 text-brand-charcoal">맛집 빙고</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-beige rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-brand-orange font-bold text-sm sm:text-base">1</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-beige rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-brand-orange font-bold text-sm sm:text-base">2</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-beige rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-brand-orange font-bold text-sm sm:text-base">3</span>
            </div>
