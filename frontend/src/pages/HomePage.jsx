  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <section className="text-center py-8 sm:py-12 px-4 bg-brand-cream rounded-xl sm:rounded-2xl border-2 border-dashed border-brand-charcoal/15">
        ...
        <p className="text-base sm:text-xl mb-4 sm:mb-6 text-brand-charcoal/80">맛집 탐방을 게임처럼 즐기세요!</p>
        <Link
          to="/templates"
      ...
      {/* 인기 빙고 템플릿 */}
      <section>
        <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 font-display">인기 빙고 템플릿</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {data.results?.slice(0, 3).map((template) => (
              <Link
                ...
                className="block bg-brand-cream p-4 sm:p-6 rounded-lg border border-brand-beige hover:shadow-md transition-shadow"
              >
                ...
                <p className="text-brand-orange text-sm mt-2">
      ...
      {/* 사용 방법 */}
      <section className="bg-brand-cream p-4 sm:p-8 rounded-lg border border-brand-beige">
        <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-center font-display">어떻게 하나요?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-beige rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-brand-orange font-bold text-sm sm:text-base font-display">1</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-beige rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-brand-orange font-bold text-sm sm:text-base font-display">2</span>
            </div>
          ...
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-brand-beige rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-brand-orange font-bold text-sm sm:text-base font-display">3</span>
            </div>
