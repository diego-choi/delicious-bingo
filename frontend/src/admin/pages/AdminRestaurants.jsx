...
export default function AdminRestaurants() {
  ...
  const fetchRestaurants = async () => {
    ...
    try {
      ...
      const response = await adminRestaurantsApi.getAll(params);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">식당 관리</h1>
        <Link
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center text-gray-500">등록된 식당이 없습니다.</div>
        ) : (
          <>
