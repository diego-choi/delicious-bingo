  ...
  return (
    <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg">
      ...
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h1 className="text-base sm:text-xl font-bold text-gray-800 truncate pr-2">{title}</h1>
        <span
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-3 sm:mb-4">
        <div className="text-center">
          <p className="text-2xl sm:text-3xl font-bold text-amber-600">{completedLines}</p>
          <p className="text-xs sm:text-sm text-gray-500">완료 라인</p>
        </div>
        <div className="text-center">
          <p className="text-2xl sm:text-3xl font-bold text-gray-800">{targetLines}</p>
          <p className="text-xs sm:text-sm text-gray-500">목표</p>
        </div>
        <div className="text-center">
          <p className="text-2xl sm:text-3xl font-bold text-gray-800">{activatedCells}/25</p>
